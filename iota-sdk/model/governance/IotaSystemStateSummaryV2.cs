...
/// <summary>
/// This is the JSON-RPC type for the IotaSystemStateV2 object.
...
/// </summary>
public class IotaSystemStateSummaryV2
{
    /// <summary>
    ...
    /// </summary>
    [JsonProperty("safeModeComputationCharges")]
    public ulong SafeModeComputationCharges { get; set; }

    /// <summary>
    /// Amount of burned computation charges accumulated during safe mode.
    /// </summary>
    [JsonProperty("safeModeComputationChargesBurned")]
    public ulong SafeModeComputationChargesBurned { get; set; }
    ...
    /// <summary>
    /// List of committee validators in the current epoch. Each element is an index pointing to activeValidators.
    /// </summary>
    [JsonProperty("committeeMembers")]
    public List<ulong> CommitteeMembers { get; set; }
